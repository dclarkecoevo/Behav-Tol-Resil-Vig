...
\textbf{ETol}: The change in velocity between the early infection behavioral trial and the before trial. Used as a point tolerance metric for the fish. ($cm/s$) \newline
\textbf{LTol}: The change in velocity between the Late infection behavioral trial and the before trial. Used as a point tolerance metric for the fish. ($cm/s$) \newline
\textbf{LtrTol}: The change in velocity between the Later infection behavioral trial and the before trial. Used as a point tolerance metric for the fish. ($cm/s$) \newline
